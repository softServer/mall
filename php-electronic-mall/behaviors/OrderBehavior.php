...
//        ]);
    ...
    private function share_money($id)
    {
        ...
        //一级佣金发放
        if ($this->share_setting->level > 1 || ($this->share_setting->level == 1 && ($this->share_setting->is_rebate == 0 || $user->is_distributor == 0))) {
        ...
        //二级佣金发放
        if ($this->share_setting->level > 2 || ($this->share_setting->level == 2 && ($this->share_setting->is_rebate == 0 || $user->is_distributor == 0))) {
        ...
        //三级佣金发放
        if ($this->share_setting->level >= 3 && ($this->share_setting->is_rebate == 0 || $user->is_distributor == 0)) {
