                ...
                <div class="temp-1 p-4">
                    ...
                    <div class="pb-2" style="width: 22.6rem;">
                        <template v-for="(item,index) in modules_list">
                            ...
                            <div class="d-flex flex-row flex-wrap" style="border-top: 1px solid #eee;border-left: 1px solid #eee;width: 100%;">
                                <template v-for="(value,key) in item.sub">
                                    <div class="modules" :data-type="value.type">
                                        ...
                                        <div>{{value.name}}</div>
                                        <div v-if="value.type == 'ad'" class="fs-sm text-danger">只能添加一个</div>
                                    </div>
                                </template>
                            </div>
                        </template>
                                ...
                                <div id="sortList">
                                    ...
                                    <template v-else>
                                        <template v-for="(item,index) in temp_list">
                                            <div :class="(index == temp_index && item.type != 'modal') ? 'block active' : 'block'">
                                                <?= $this->render('temp.php'); ?>
                                                <div class="block-handle block-handle-left" v-if="index == temp_index && item.type != 'modal'">
                                                ...
                                                <div class="block-handle block-handle-right" v-if="index == temp_index && item.type != 'modal'">
                                                    <div class="handle up" v-if="index > 0" title="上移组件">
                                                        <img src="<?= $statics ?>/mch/images/up.png">
                                                    </div>
                                                    <div class="handle down" v-if="index < temp_list.length-1" title="下移组件">
                                                        <img src="<?= $statics ?>/mch/images/up.png">
                                                    </div>
                                                </div>
                                            </div>
